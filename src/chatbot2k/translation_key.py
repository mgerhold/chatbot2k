...
class TranslationKey(StrEnum):
    ...
    COMMAND_UPDATE_CAUSES_AMBIGUITY = "COMMAND_UPDATE_CAUSES_AMBIGUITY"
    ...
    CANNOT_ADD_OR_UPDATE_SCRIPT_COMMAND = "CANNOT_ADD_OR_UPDATE_SCRIPT_COMMAND"
    SOUNDBOARD_MANAGED_VIA_WEB_UI = "SOUNDBOARD_MANAGED_VIA_WEB_UI"
